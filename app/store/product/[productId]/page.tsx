...
import { 
  ...
  Ticket, Check, AlertCircle, Copy, X, Sparkles, Gift, Download
} from "lucide-react"
            ...
            {product?.downloadUrl && (
              <div className="border-t border-border px-5 py-4">
                <h3 className="font-semibold text-sm text-foreground mb-2 flex items-center gap-1.5">
                  ...
                  ดาวน์โหลดสินค้าของคุณ
                </h3>
                <a
                  href={product.downloadUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary/10 hover:bg-primary/20 border border-primary/20 px-4 py-3 text-sm font-bold text-primary transition-colors"
                >
                  <Download className="h-4 w-4" />
                  คลิกเพื่อดาวน์โหลดไฟล์สินค้า
                </a>
                <p className="text-[10px] text-muted-foreground mt-1.5">
                  * ลิงก์ดาวน์โหลดนี้ได้เฉพาะสำหรับคุณที่ซื้อสินค้าแล้วเท่านั้น
                </p>
              </div>
            )}
